...
import SmallMostLeastOptions from './question-types/small-most-least-options.js'
...
*/
export default function generate_questions(assessmentId,questions_json,_nextFunction,parent){
...
questions.forEach(function(question,index){
  ...
  case "small-text-input":
    ...
    break;
    case "small-most-least-options":
        jsx_objects_array.push(<div className="well question"><SmallMostLeastOptions assessmentId={assessmentId} questionNumber={question.id} question={question.question} options={question.options}/><NextButton skippable={is_required(question.id)} nextFunc={_nextFunction.bind(parent,is_required(question.id))}/></div>);
      break;
