...
function Store(){
  ...
  return (function(assessmentId,questionNumber,value,action={}){
  //console.log("============== assessmentId ==========> " + assessmentId);
  if ( stored[0] === null || stored[0] === undefined) {
      stored[0] = assessmentId;
        console.log("============== updating stored[0] ==========> " + stored[0] );
  }
